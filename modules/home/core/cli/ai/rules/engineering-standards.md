...
## Remote Hosts Require Confirmation

Never ssh into a host, or run any remote or write operation against one, without
explicit confirmation first. This includes read-only inspection commands
